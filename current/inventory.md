...
- `~/grubber` added analysis live updates and a progress view on August 6, including new analysis query/progress APIs, fast-tick scheduling, CLI support, and test coverage. This is committed local work; deployment of these additions has not yet been verified.
